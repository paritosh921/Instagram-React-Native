...
const Post = () => {
  const postInfo = [
    {
      postTitle: 'Kim',
      postPersonImage: require('../../storage/images/profilePic.jpg'),
    ...
    {
      postTitle: 'Vedansh',
      postPersonImage: require('../../storage/images/post2.jpg'),
    ...
    {
      postTitle: 'Arnav',
      postPersonImage: require('../../storage/images/post5.jpg'),
    ...
    {
      postTitle: 'Utkarsh',
      postPersonImage: require('../../storage/images/post6.jpg'),
